...
<br>
- 只需提供一个<b>音频</b>和一段<b>字幕</b>、<b>几张图片</b>，就可以快速生成高清短视频。
- 支持在任意位置添加、字体大小、颜色的文字和图片水印。
- 支持自动检测音频的时间轴。
- 支持自动将文案或字幕按照音频时间轴规划，并按时间轴合成到短视频中。
- 支持自定义字幕的显示位置、字体大小、颜色。
- 支持字幕时间全局偏移
- 支持自定义位置、大小、颜色的文字或图片水印添加。
- 支持生成的短视频在线预览、下载。
- 文案语言无限制。

## 功能扩展
- 代码简洁，备注清晰，易于学习和维护，基于gradio原生，支持<b>AP</b>和<b>web界面</b>
- 方便扩展大模型文案自动生成、tts语音合成

### 下阶段计划
- TTS 离线情感语音合成模型支持（如：indextts2）
- OpenAI api v1通用接口支持（支持大多数模型api）
- 增加视频上传合成短视频
